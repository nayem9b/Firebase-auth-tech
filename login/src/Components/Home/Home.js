...
const Home = () => {
  return (
    <div>
      ...
      {/* header goes here */}
      <section class='lg:mt-96 overflow-hidden bg-[url(https://images.unsplash.com/photo-1602810319428-019690571b5b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1770&q=80)] bg-cover bg-center bg-no-repeat'>
      ...
      <footer
        ...
        class='bg-gray-900 text-white lg:grid lg:grid-cols-5 lg:mt-96'>
